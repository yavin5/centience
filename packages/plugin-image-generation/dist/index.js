...
var require_internal = __commonJS({
  "../../node_modules/encoding/node_modules/iconv-lite/encodings/internal.js"(exports, module) {
    ...
    InternalEncoder.prototype.write = function(str3) {
      return Buffer3.from(str3, this.enc);
    };
    ...
    InternalEncoderBase64.prototype.write = function(str3) {
      ...
      return Buffer3.from(str3, "base64");
    };
    ...
    InternalEncoderCesu8.prototype.write = function(str3) {
      var buf = Buffer3.alloc(str3.length * 3), bufIdx = 0;
...
var require_utf32 = __commonJS({
  "../../node_modules/encoding/node_modules/iconv-lite/encodings/utf32.js"(exports) {
    ...
    Utf32Encoder.prototype.write = function(str3) {
      var src = Buffer3.from(str3, "ucs2");
...
var require_utf16 = __commonJS({
  "../../node_modules/encoding/node_modules/iconv-lite/encodings/utf16.js"(exports) {
    ...
    Utf16BEEncoder.prototype.write = function(str3) {
      var buf = Buffer3.from(str3, "ucs2");
...
var require_utf7 = __commonJS({
  "../../node_modules/encoding/node_modules/iconv-lite/encodings/utf7.js"(exports) {
    ...
    Utf7Encoder.prototype.write = function(str3) {
      return Buffer3.from(str3.replace(nonDirectChars, function(chunk) {
    ...
    Utf7IMAPEncoder.prototype.write = function(str3) {
      var inBase64 = this.inBase64, base64Accum = this.base64Accum, base64AccumIdx = this.base64AccumIdx, buf = Buffer3.alloc(str3.length * 5 + 10), bufIdx = 0;
...
var require_sbcs_codec = __commonJS({
  "../../node_modules/encoding/node_modules/iconv-lite/encodings/sbcs-codec.js"(exports) {
    ...
    SBCSEncoder.prototype.write = function(str3) {
      var buf = Buffer3.alloc(str3.length);
      for (var i = 0; i < str3.length; i++)
...
var require_dbcs_codec = __commonJS({
  "../../node_modules/encoding/node_modules/iconv-lite/encodings/dbcs-codec.js"(exports) {
    ...
    DBCSEncoder.prototype.write = function(str3) {
      var newBuf = Buffer3.alloc(str3.length * (this.gb18030 ? 4 : 3)), leadSurrogate = this.leadSurrogate, seqObj = this.seqObj, nextChar = -1, i2 = 0, j = 0;
      while (true) {
        if (nextChar === -1) {
...
var require_lib = __commonJS({
  "../../node_modules/encoding/node_modules/iconv-lite/lib/index.js"(exports, module) {
    ...
    iconv.encode = function encode2(str3, encoding, options) {
      str3 = "" + (str3 || "");
...
var require_encoding = __commonJS({
  "../../node_modules/encoding/lib/encoding.js"(exports, module) {
    ...
    function convert2(str3, to, from) {
      from = checkEncoding(from || "UTF-8");
      to = checkEncoding(to || "UTF-8");
      str3 = str3 || "";
      var result;
      if (from !== "UTF-8" && typeof str3 === "string") {
        str3 = Buffer.from(str3, "binary");
      }
      if (from === to) {
        if (typeof str3 === "string") {
          result = Buffer.from(str3);
        } else {
          result = str3;
        }
      } else {
        try {
          result = convertIconvLite(str3, to, from);
        } catch (E) {
          console.error(E);
          result = str3;
        }
    ...
    function convertIconvLite(str3, to, from) {
      if (to === "UTF-8") {
        return iconvLite.decode(str3, from);
      } else if (from === "UTF-8") {
        return iconvLite.encode(str3, to);
      } else {
        return iconvLite.encode(iconvLite.decode(str3, from), to);
      }
    }
